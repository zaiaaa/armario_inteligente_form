    ...
    <>
        ...
        <div className="content">
        {
            ...
            (
                        ...
                        <Card key={index} maxW='sm' ml={4} mr={4} mb={4} boxShadow="lg"   border="1px solid #E2E8F0"   _hover={{ boxShadow: "xl", transform: "scale(1.02)", transition: "0.2s ease-in-out" }}>
                            <CardBody>
                                <Image
                                ...
                                <Text color={"#FF0000"}>
                                    {lockout.status == "retirado" ? `Local: ${lockout.local}` : ""}
                                </Text>
                                ...
                                {lockout.status == "retirado" ? <Divider borderColor={"#000"} /> : ""}
                                <Text color={"#FF0000"}>
                                    {lockout.status == "retirado" ? `Retirado por: ${lockout.nome}` : ""}
                                </Text>
